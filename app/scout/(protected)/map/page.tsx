...
export default function ScoutMapPage() {
  ...
  return (
    <div className="hz-scout-map-page">
      ...
      <main className="hz-scout-map-container" style={{ position: 'relative' }}>
        {isTracking && gpsAccuracy !== null && gpsAccuracy > 20 && (
          <div style={{ position: 'absolute', top: '1rem', left: '1rem', right: '1rem', zIndex: 1000, backgroundColor: 'rgba(255, 166, 0, 0.9)', color: '#000', padding: '0.5rem 1rem', borderRadius: '8px', fontSize: '0.875rem', fontWeight: 600, display: 'flex', alignItems: 'center', gap: '0.5rem', boxShadow: '0 4px 6px rgba(0,0,0,0.1)' }}>
            <span>⚠️</span> Poor GPS Signal (Accuracy: {gpsAccuracy.toFixed(0)}m). Waiting for &lt;20m...
          </div>
        )}
        ...
        <ScoutMapClient 
          ...
          onAccuracyUpdate={setGpsAccuracy}
        />
